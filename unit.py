...
def create_logger(loggername: str = 'logger', levelname: str = 'DEBUG', console_levelname='INFO'):
    ...
    handler_common = logging.FileHandler(
        common_filename, mode='a+', encoding='utf-8')
...
logger = create_logger('xuexi', console_levelname=cfg.get(
    "prefers", "console_levelname"))

# users_info =dict(configs['userinfo'])
